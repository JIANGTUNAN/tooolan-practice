package com.tooolan.ddd.infra.db.persistence.dept.repository;
...
import com.tooolan.ddd.infra.db.persistence.dept.converter.DeptInfraConverter;
import com.tooolan.ddd.infra.db.persistence.dept.entity.SysDeptEntity;
import com.tooolan.ddd.infra.db.persistence.dept.mapper.SysDeptMapper;
...
public class DeptRepositoryImpl extends ServiceImpl<SysDeptMapper, SysDeptEntity> implements DeptRepository {
    ...
    public PageQueryResult<Dept> page(PageDeptParam param) {
        IPage<Dept> page = super.lambdaQuery()
                ...
                .like(StrUtil.isNotBlank(param.getDeptCode()), SysDeptEntity::getDeptCode, param.getDeptCode())
